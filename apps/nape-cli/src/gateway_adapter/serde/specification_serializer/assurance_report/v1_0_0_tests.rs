...
fn success() {
    ...
    assert_eq!(
        report_file.subject.id,
        "9f3f183a300501b53e2fa04f48acb4bd478d6414"
    );
    assert_eq!(
        report_file.procedure.repository,
        "git://github.com/nape/processes"
    );
    assert_eq!(
        report_file.procedure.directory,
    ...
    assert_eq!(
        actual_action1.test_file.signature,
        "SHA256[theaction1testsig]"
    );
    assert_eq!(actual_action1.evidence_file.file, "evidence_file.txt");
    assert_eq!(
        actual_action1.evidence_file.signature,
        "SHA256[theaction1evidencesig]"
    );
    ...
    assert_eq!(
        actual_action2.test_file.signature,
        "SHA256[theaction2testsig]"
    );
    assert_eq!(actual_action2.evidence_file.file, "evidence_file.txt");
    assert_eq!(
        actual_action2.evidence_file.signature,
        "SHA256[theaction2evidencesig]"
    );
    ...
    assert_eq!(
        actual_action3.test_file.signature,
        "SHA256[theaction3testsig]"
    );
    assert_eq!(actual_action3.evidence_file.file, "evidence_file.txt");
    assert_eq!(
        actual_action3.evidence_file.signature,
        "SHA256[theaction3evidencesig]"
    );
    ...
    assert_eq!(
        actual_action4.test_file.signature,
        "SHA256[theaction4testsig]"
    );
    assert_eq!(actual_action4.evidence_file.file, "evidence_file.txt");
    assert_eq!(
        actual_action4.evidence_file.signature,
        "SHA256[theaction4evidencesig]"
    );
}
