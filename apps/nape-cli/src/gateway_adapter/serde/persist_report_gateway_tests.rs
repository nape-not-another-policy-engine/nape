...
use kernel_oss::values::specification::assurance_report::activity::Activity;
...
mod persist_assurance_report_v1 {
    use super::*;
    use std::fs;
    use test_framework_oss::{canonical_path, create, remove};
    ...
    fn success() {
        ...
        let action1 = Action::builder()
            ...
            .reason("Test passed")
            .test_file_path("test_file.txt")
            .test_file_signature("SHA256[theaction1testsig]")
            .evidence_file_path("evidence_file.txt")
            .evidence_file_signature("SHA256[theaction1evidencesig]")
            .try_build()
            .unwrap();
        let action2 = Action::builder()
            ...
            .reason("Test failed")
            .test_file_path("test_file.txt")
            .test_file_signature("SHA256[theaction2testsig]")
            .evidence_file_path("evidence_file.txt")
            .evidence_file_signature("SHA256[theaction2evidencesig]")
            .try_build()
            .unwrap();
        let action3 = Action::builder()
            ...
            .reason("Test inconclusive")
            .test_file_path("test_file.txt")
            .test_file_signature("SHA256[theaction3testsig]")
            .evidence_file_path("evidence_file.txt")
            .evidence_file_signature("SHA256[theaction3evidencesig]")
            .try_build()
            .unwrap();
        let action4 = Action::builder()
            ...
            .reason("Test passed")
            .test_file_path("test_file.txt")
            .test_file_signature("SHA256[theaction4testsig]")
            .evidence_file_path("evidence_file.txt")
            .evidence_file_signature("SHA256[theaction4evidencesig]")
            .try_build()
            .unwrap();
        let action5 = Action::builder()
            .name("action-5")
            .outcome("pass")
            .reason("Test passed")
            .test_file_path("test_file.txt")
            .test_file_signature("SHA256[theaction5testsig]")
            .evidence_file_path("evidence_file.txt")
            .evidence_file_signature("SHA256[theaction5evidencesig]")
            .try_build()
            .unwrap();
        let action6 = Action::builder()
            .name("action-6")
            .outcome("fail")
            .reason("Test failed")
            .test_file_path("test_file.txt")
            .test_file_signature("SHA256[theaction6testsig]")
            .evidence_file_path("evidence_file.txt")
            .evidence_file_signature("SHA256[theaction6evidencesig]")
            .try_build()
            .unwrap();
        let action7 = Action::builder()
            .name("action-7")
            .outcome("inconclusive")
            .reason("Test inconclusive")
            .test_file_path("test_file.txt")
            .test_file_signature("SHA256[theaction7testsig]")
            .evidence_file_path("evidence_file.txt")
            .evidence_file_signature("SHA256[theaction7evidencesig]")
            .try_build()
            .unwrap();
        ...
        let activity2 = Activity::builder()
            ...
            .try_build()
            .unwrap();
        let activity3 = Activity::builder()
            .name("activity-3")
            .add(&action5)
            .add(&action6)
            .add(&action7)
        ...
        let result_contents =
            fs::read_to_string(result_file_path.as_str()).expect("Unable to read file");

        // Compare with expected YAML
        let expected_contents = expected_yaml();
        assert_eq!(
            result_contents, expected_contents,
            "The YAML contents do not match"
        );
