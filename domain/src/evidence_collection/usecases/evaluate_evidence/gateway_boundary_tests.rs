...
use crate::evidence_collection::usecases::evaluate_evidence::gateway_boundary::{
...
mod request {
    ...
    fn from_procedure_many_activity_many_tests_success() {
        let activity1 =
            Activity::new("activity-1", "short description", "long description").unwrap();
        let activity2 =
            Activity::new("activity-2", "short description", "long description").unwrap();
        let activity3 =
            Activity::new("activity-3", "short description", "long description").unwrap();

        let a1_action1 = Action::builder()
            .name("action-1-1")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_1_1")
            .evidence_file_path("evidence/test_dir/evidence_file_1_1")
            .try_build()
            .unwrap();
        let a1_action2 = Action::builder()
            .name("action-1-2")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_1_2")
            .evidence_file_path("evidence/test_dir/evidence_file_1_2")
            .try_build()
            .unwrap();
        let a1_action3 = Action::builder()
            .name("action-1-3")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_1_3")
            .evidence_file_path("evidence/test_dir/evidence_file_1_3")
            .try_build()
            .unwrap();
        let activity1 = activity1.add(a1_action1).add(a1_action2).add(a1_action3);

        let a2_action1 = Action::builder()
            .name("action-2-1")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_2_1")
            .evidence_file_path("evidence/test_dir/evidence_file_2_1")
            .try_build()
            .unwrap();
        let a2_action2 = Action::builder()
            .name("action-2-2")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_2_2")
            .evidence_file_path("evidence/test_dir/evidence_file_2_2")
            .try_build()
            .unwrap();
        let a2_action3 = Action::builder()
            .name("action-2-3")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_2_3")
            .evidence_file_path("evidence/test_dir/evidence_file_2_3")
            .try_build()
            .unwrap();
        let activity2 = activity2.add(a2_action1).add(a2_action2).add(a2_action3);

        let a3_action1 = Action::builder()
            .name("action-3-1")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_3_1")
            .evidence_file_path("evidence/test_dir/evidence_file_3_1")
            .try_build()
            .unwrap();
        let a3_action2 = Action::builder()
            .name("action-3-2")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_3_2")
            .evidence_file_path("evidence/test_dir/evidence_file_3_2")
            .try_build()
            .unwrap();
        let a3_action3 = Action::builder()
            .name("action-3-3")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("activity/test_dir/test_file_3_3")
            .evidence_file_path("evidence/test_dir/evidence_file_3_3")
            .try_build()
            .unwrap();
        ...
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_1_1",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_1_1",
            )],
        );
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_1_2",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_1_2",
            )],
        );
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_1_3",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_1_3",
            )],
        );
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_2_1",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_2_1",
            )],
        );
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_2_2",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_2_2",
            )],
        );
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_2_3",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_2_3",
            )],
        );
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_3_1",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_3_1",
            )],
        );
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_3_2",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_3_2",
            )],
        );
        expected_tests.insert(
            EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence/test_dir/evidence_file_3_3",
            ),
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/activity/test_dir/test_file_3_3",
            )],
        );
    ...
    fn from_procedure_action_evidence_duplicates_action_test_unique_success() {
        ...
        let a1_action1 = Action::builder()
            ...
            .short_description("short description")
            .long_description("long description")
            .test_file_path("test_file_1_1")
            .evidence_file_path("evidence_file_1_1")
            .try_build()
            .unwrap();
        let a1_action2 = Action::builder()
            .name("action-1-2")
        ...
        let a1_action3 = Action::builder()
            ...
            .short_description("short description")
            .long_description("long description")
            .test_file_path("test_file_1_3")
            .evidence_file_path("evidence_file_1_2")
            .try_build()
            .unwrap();
        let activity1 = activity1.add(a1_action1).add(a1_action2).add(a1_action3);
        ...
        let a2_action1 = Action::builder()
            ...
            .short_description("short description")
            .long_description("long description")
            .test_file_path("test_file_2_1")
            .evidence_file_path("evidence_file_2_1")
            .try_build()
            .unwrap();
        let a2_action2 = Action::builder()
            .name("action-2-2")
            .short_description("short description")
            .long_description("long description")
            .test_file_path("test_file_2_2")
            .evidence_file_path("evidence_file_2_2")
            .try_build()
            .unwrap();
        let a2_action3 = Action::builder()
            .name("action-2-3")
        ...
        let a3_action1 = Action::builder()
            ...
            .short_description("short description")
            .long_description("long description")
            .test_file_path("test_file_3_1")
            .evidence_file_path("evidence_file_3_1")
            .try_build()
            .unwrap();
        let a3_action2 = Action::builder()
            .name("action-3-2")
        ...
        let a3_action3 = Action::builder()
            ...
            .short_description("short description")
            .long_description("long description")
            .test_file_path("test_file_3_3")
            .evidence_file_path("evidence_file_3_3")
            .try_build()
            .unwrap();
        let activity3 = activity3.add(a3_action1).add(a3_action2).add(a3_action3);
        ...
        expected_tests.insert(
            ...
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/test_file_1_3",
            )],
        );
        ...
        expected_tests.insert(
            ...
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/test_file_2_1",
            )],
        );
        expected_tests.insert(
        ...
        expected_tests.insert(
            ...
            vec![TestFilePath::from(
                "/Users/someone/procedure/home/test_file_3_3",
            )],
        );
    ...
    fn from_procedure_many_activity_duplicate_evidence_many_tests_success() {
        ...
        let evidence_file_1_1 = evidence_action_files
            .file_map
            .get(&EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence_file_1_1",
            ))
            .unwrap();
        assert_eq!(*evidence_file_1_1, expect_file_1_1);

        let evidence_file_2_1 = evidence_action_files
            .file_map
            .get(&EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence_file_2_1",
            ))
            .unwrap();
        assert_eq!(*evidence_file_2_1, expect_file_2_1);

        let evidence_file_3_1 = evidence_action_files
            .file_map
            .get(&EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence_file_3_1",
            ))
            .unwrap();
    ...
    fn from_procedure_many_activity_duplicate_evidence_many_test_duplicate_tests_success() {
        ...
        let a2_action3 = Action::builder()
            ...
            .long_description("long description")
            .test_file_path("test_file_2_3")
            .evidence_file_path("evidence_file_2_3")
            .try_build()
            .unwrap();
        let activity2 = activity2.add(a2_action1).add(a2_action2).add(a2_action3);
        ...
        let expect_file_1_2 = vec![TestFilePath::from(
            "/Users/someone/procedure/home/test_file_1_3",
        )];

        let expect_file_2_3 = vec![TestFilePath::from(
            "/Users/someone/procedure/home/test_file_2_3",
        )];
        ...
        let evidence_file_1_2 = evidence_action_files
            .file_map
            .get(&EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence_file_1_2",
            ))
            .unwrap();
        assert_eq!(*evidence_file_1_2, expect_file_1_2);

        let evidence_file_2_3 = evidence_action_files
            .file_map
            .get(&EvidenceFilePath::from(
                "/Users/someone/procedure/home/evidence_file_2_3",
            ))
            .unwrap();
    ...
    fn add_success() {
        ...
        let actual_test_files1 = evaluation_files
            .file_map
            .get(&EvidenceFilePath::from("new_evidence_file.yaml"))
            .unwrap();
        let expected_test_files1 = vec![
            TestFilePath::from("new_test_file.yaml"),
            TestFilePath::from("test_file2.yaml"),
        ];

        let actual_test_files2 = evaluation_files
            .file_map
            .get(&EvidenceFilePath::from("evidence_file2.yaml"))
            .unwrap();
...
mod response {
    ...
    fn add_result_success() {
        ...
        let evaluation_results =
            evaluation_results.add_result(&evidence_file, &test_file1, result1);
        let evaluation_results =
            evaluation_results.add_result(&evidence_file, &test_file2, result2);
        let evaluation_results =
            evaluation_results.add_result(&evidence_file, &test_file3, result3);
        let evaluation_results =
            evaluation_results.add_result(&evidence_file, &test_file4, result4);

        /* Assert */
        let retrieve_result1 = evaluation_results
            .result_for(&evidence_file, &test_file1)
            .unwrap();
        let retrieve_result2 = evaluation_results
            .result_for(&evidence_file, &test_file2)
            .unwrap();
        let retrieve_result3 = evaluation_results
            .result_for(&evidence_file, &test_file3)
            .unwrap();
        let retrieve_result4 = evaluation_results
            .result_for(&evidence_file, &test_file4)
            .unwrap();
